...
<ul class="x_nav x_nav-tabs">
	<li @class(['x_active' => $act === 'dispMcpserverAdminConfig'])>
		<a href="@url(['module' => 'admin', 'act' => 'dispMcpserverAdminConfig'])">{{ $lang->cmd_mcpserver_general_config }}</a>
	</li>
</ul>
...
<form class="x_form-horizontal" action="./" method="post" id="mcpserver">
	...
	<section class="section">
		<div class="x_control-group">
			<label class="x_control-label" for="example_config">{{ $lang->cmd_mcpserver_example_config}} </label>
